...
kdeglobals = f"{home}/.config/kdeglobals"
...
def get_single_click() -> bool:
    return bool(__get_value_for_key_in_file(kxkbrc_path, "SingleClick"))
def set_single_click(single_click: bool):
    __set_value_for_key_in_file(kxkbrc_path, "SingleClick", single_click)
